...
class _ObjectsOnPlanesWidgetState extends State<ObjectsOnPlanesWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Check VR view'),
        ),
        body: Container(
    ...
    if (singleHitTestResult != null) {
      ...
      if (didAddAnchor!) {
        ...
        var newNode = ARNode(
            ...
            uri:
                "https://firebasestorage.googleapis.com/v0/b/avit-ba03d.appspot.com/o/feast%20of%20sharing%20dataset%2Funtitled.glb?alt=media&token=87fa8105-9c7b-4755-9690-cb75bb19210f",
