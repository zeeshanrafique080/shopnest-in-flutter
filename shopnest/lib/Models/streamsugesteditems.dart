...
class streaamsuggesteditems extends StatefulWidget {
  final Axis scrollDirection;
  final double size;
  final ScrollPhysics scrollphysics;
  final int crosscountaxis;

  const streaamsuggesteditems(
      {Key? key,
      required this.size,
...
class _StreamBuilderState extends State<streaamsuggesteditems> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          ...
          .orderBy("sales quantity", descending: true)
          .snapshots(),
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Spacer(),
                                    FavoriteButton(
                                      isFavorite: mauth.currentUser != null
                                          ? favid
