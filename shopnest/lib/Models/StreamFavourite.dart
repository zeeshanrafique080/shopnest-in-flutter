...
class StreamFavourite extends StatefulWidget {
  ...
  @override
  _StreamFavouriteState createState() => _StreamFavouriteState();
}

class _StreamFavouriteState extends State<StreamFavourite> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          ...
          .where("liked by", arrayContains: mauth.currentUser!.uid.toString())
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => ProductViewScreen(
                                            catagoryname:
                                                curDoc.get("item catagory"),
                                            subcatagoryname:
                                                curDoc.get("item sub_catagory"),
                                            totalinventory:
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    FavoriteButton(
                                      isFavorite: favid
                                          .contains(mauth.currentUser!.uid),
                                      iconSize: 35,
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                ProductViewScreen(
                                                  catagoryname: curDoc
                                                      .get("item catagory"),
                                                  subcatagoryname: curDoc
                                                      .get("item sub_catagory"),
