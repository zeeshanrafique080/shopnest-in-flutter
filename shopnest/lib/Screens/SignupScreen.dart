    ...
    try {
      ...
      await FirebaseAuth.instance
        ...
        if (value.additionalUserInfo!.isNewUser) {
          final custmomerjson = {
            "temp sum": 0.toString(),
            "consumer name": namecontroller.text.toString().trim(),
            "consumer phone": phonecontroller.text.toString().trim(),
            "consumer country": "none",
            "consumer email": _emailcontroller.text.toString().trim(),
            "consumer uid": value.user!.uid.toString().trim()
          };
          await FirebaseFirestore.instance
            ...
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => MainDisplayScreen()));
          });
        } else {
